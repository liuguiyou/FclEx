...
{
    /// <summary>
    /// Used to store FwModuleInfo objects as a dictionary.
    /// </summary>
    internal class FwModuleCollection : List<FwModuleInfo>
    {
        public Type StartupModuleType { get; }

        public FwModuleCollection(Type startupModuleType)
        {
        ...
        public TModule GetModule<TModule>() where TModule : FwModule
        {
        ...
        public List<FwModuleInfo> GetSortedModuleListByDependency()
        {
        ...
        public static void EnsureKernelModuleToBeFirst(List<FwModuleInfo> modules)
        {
            var kernelModuleIndex = modules.FindIndex(m => m.Type == typeof(FwKernelModule));
        ...
        public static void EnsureStartupModuleToBeLast(List<FwModuleInfo> modules, Type startupModuleType)
        {
